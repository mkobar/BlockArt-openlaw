...
class OpenLaw extends Component {
  ...
  constructor(props) {
    ...
    this.appCredsUsername = 'u0ojinnyf1'
    //this.appCredsPassword = React.createRef()
    this.appCredsPassword = 'SiivBcpjMLjL-NHE2R4GnVHPs8EJvyvTgo-z_1IwiD0'
    //this.nodeRpcEndpoint = React.createRef()
    //this.nodeRpcEndpoint = 'https://u0hypkfkj9-u0rgnf050w-rpc.us0-aws.kaleido.io'
    this.nodeRpcEndpoint = 'u0hypkfkj9-u0rgnf050w-rpc.us0-aws.kaleido.io'
    ...
    //this.openlawRpcEndpoint = 'https://u0hypkfkj9-u0n69vd25o-openlaw.us-east-2-svcs.kaleido.io'
    this.openlawRpcEndpoint = 'u0hypkfkj9-u0n69vd25o-openlaw.us-east-2-svcs.kaleido.io'
    //this.openlawAccountEmail = React.createRef()
    this.openlawAccountEmail = 'mike@rkosecurity.com'
    //this.openlawAccountPassword = React.createRef()
    this.openlawAccountPassword = 'mOcbxhNSdRiEc0eHfmSybCE4hOosz3KIJj6NWkkuIG'
